...
// upper end of standard packet loss
// fn create_loss() -> SwarmNetworkLoss {
//     SwarmNetworkLoss {
//         loss_percentage: 2,
//         correlation_percentage: 50,
//     }
...
impl NetworkLoadTest for ThreeRegionSimulationTest {
    fn setup(&self, ctx: &mut NetworkContext) -> anyhow::Result<LoadDestination> {
        ...
        // TODO(rustielin): investigate concurrent netem NetworkChaos: https://github.com/chaos-mesh/chaos-mesh/issues/3631
        // inject loss
        // let loss = create_loss();
        // let chaos = SwarmChaos::Loss(loss);
        // ctx.swarm().inject_chaos(chaos)?;
