...
impl Default for IndexerConfig {
    fn default() -> Self {
        Self {
            ...
            postgres_uri: default_database_url(),
            processor: default_processor_name(),
            starting_version: default_starting_version(),
            skip_migrations: false,
            index_token_uri_data: false,
            check_chain_id: default_true(),
            batch_size: default_batch_size(),
            fetch_tasks: default_fetch_tasks(),
            processor_tasks: default_processor_tasks(),
